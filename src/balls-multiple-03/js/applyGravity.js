blindfish.applyBallGravity = function (thing0, thing1, dx, dy, distSquared) {
  //TODO add test for object type
  ...
  if (dist > (thing0.rad + thing1.rad) / 2) {
    ...
    if (thing0.polarity * thing1.polarity > 0 && blindfish.g.polarityOn) {
      ax = (-force * dx) / dist;
      ay = (-force * dy) / dist;
    } else {
      ax = (force * dx) / dist;
