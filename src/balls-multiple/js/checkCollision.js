...
blindfish.checkCollision = function (thing0, thing1, dx, dy, distSquared) {
    ...
    if (distSquared < (thing0.rad + thing1.rad) * (thing0.rad + thing1.rad)) {
        ...
        var angle = Math.atan2(dy, dx),
            ...
            vel0 = blindfish.rotateVector(thing0.vx,
                thing0.vy,
                sine,
                cosine,
                true),
            ...
            vel1 = blindfish.rotateVector(thing1.vx,
                thing1.vy,
                sine,
                cosine,
                true),
        ...
        vel0.x = ((thing0.mass - thing1.mass) * vel0.x +
                2 * thing1.mass * vel1.x) /
        ...
        pos0F = blindfish.rotateVector(pos0.x,
                pos0.y,
                sine,
                cosine,
                false),

            pos1F = blindfish.rotateVector(pos1.x,
                pos1.y,
                sine,
                cosine,
                false);
        ...
        var vel0F = blindfish.rotateVector(vel0.x,
                vel0.y,
                sine,
                cosine,
                false),

            vel1F = blindfish.rotateVector(vel1.x,
                vel1.y,
                sine,
                cosine,
                false);
