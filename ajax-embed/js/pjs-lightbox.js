 ...
 (function () {
     ...
     sketchCanvas.innerHTML = "<p>Your browser does not support the canvas tag.</p>";
     canvasWrapper.innerHTML = "<noscript><p>JavaScript is required to view the contents of this page.</p></noscript>";
