...
//TODO: clearly lots of work to do on understanding Browserify!!!
// 'this' in prototype = window :/
...
circle.prototype.draw = function() {
    ...
    p.ellipse(this.x, this.y, this.vars.radius, this.vars.radius);
}
    ...
    p.setup = function() {
        ...
        controls.addControlGroup([{
                    ...
                    callback: function(val) {
                        ...
                        // Alternatively you can do the work required to maintain scope:
        ...
        controls.addControlGroup([{
            ...
            callback: function(val) {
                vars.background = vars.sketchColours[val];
            }
        }, ], "sketch options");
